...
pub enum InstructionType {
    ...
    // Note: CreateAtaInvoke (4) and CreateAtaInvokeSigned (5) removed - use CreateAta2 variants instead
...
impl TryFrom<u8> for InstructionType {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            ...
            // 4 and 5 removed - use CreateAta2 variants (10, 11) instead
...
mod tests {
    ...
    fn test_instruction_discriminators() {
        ...
        // CreateAtaInvoke (4) and CreateAtaInvokeSigned (5) removed
    ...
    fn test_instruction_type_conversion() {
        ...
        // 4 and 5 removed - now return errors
        assert!(InstructionType::try_from(4).is_err());
        assert!(InstructionType::try_from(5).is_err());
        assert_eq!(
