# Create Compressed Account Program (Anchor)

A program built with the Anchor framework to create a zk-compressed account with a custom message field.
...
2. Start the test validator
   ...
   ```bash
   light test-validator --sbf-program "6pJwGkAuV2MtBanB3Fdugknra7TAKbN3ERsT6Gg2PwgE" ./target/deploy/program_create.so
   ```
