...
if [ $? -eq 0 ]; then
    ...
    echo "  - Generated: build/private_transfer.r1cs"
    echo "  - Generated: build/private_transfer.wasm"
    echo "  - Generated: build/private_transfer.sym"
else
...
echo "  - build/private_transfer.r1cs"
echo "  - build/private_transfer.wasm"
echo "  - build/private_transfer.sym"
echo "  - build/private_transfer_final.zkey"
echo "  - build/verification_key.json"
echo ""
echo "Next steps:"
echo "  1. Run Rust tests: ${BLUE}cargo test test_private_transfer_circuit${NC}"
