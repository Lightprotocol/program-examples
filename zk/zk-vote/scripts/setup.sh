...
circom circuits/vote_proof.circom \
    --r1cs \
    --wasm \
    --sym \
    --verbose \
...
if [ $? -eq 0 ]; then
    ...
    echo "  - Generated: build/vote_proof.r1cs"
    echo "  - Generated: build/vote_proof_js/vote_proof.wasm"
    echo "  - Generated: build/vote_proof.sym"
else
...
echo "  - build/vote_proof.r1cs"
echo "  - build/vote_proof_js/vote_proof.wasm"
echo "  - build/vote_proof.sym"
echo "  - build/vote_proof_final.zkey"
echo "  - build/verification_key.json"
echo ""
echo "Next steps:"
echo "  1. Build the program: ${BLUE}cargo build-sbf${NC}"
echo "  2. Run tests: ${BLUE}cargo test${NC}"
echo ""
