...
use crate::{CreateInstructionData, MyCompressedAccount};
use solana_sdk::{
...
async fn test_create() {
    let config = ProgramTestConfig::new(true, Some(vec![("native_program_create", crate::ID)]));
...
pub async fn create_compressed_account(
    ...
    let instruction = Instruction {
        ...
        data: [
            &[crate::InstructionType::Create as u8][..],
            &inputs[..],
        ]
        .concat(),
    };
