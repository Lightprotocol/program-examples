...
import { AnchorProgramBurn } from "../target/types/anchor_program_burn";
import idl from "../target/idl/anchor_program_burn.json";
import {
  bn,
...
describe("test-anchor", () => {
  const program = anchor.workspace.AnchorProgramBurn as Program<AnchorProgramBurn>;
...
async function CreateCounterCompressedAccount(
  ...
  program: anchor.Program<AnchorProgramBurn>,
