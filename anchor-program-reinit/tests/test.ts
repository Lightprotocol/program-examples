...
import { AnchorProgramReinit } from "../target/types/anchor_program_reinit";
import idl from "../target/idl/anchor_program_reinit.json";
import {
  bn,
...
describe("test-anchor", () => {
  const program = anchor.workspace.AnchorProgramReinit as Program<AnchorProgramReinit>;
...
async function CreateCounterCompressedAccount(
  ...
  program: anchor.Program<AnchorProgramReinit>,
