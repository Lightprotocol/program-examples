# Close Compressed Account Program (Anchor)

A program built with the Anchor framework to close a zk-compressed account. The account can be reinitialized after closing.
...
2. Start the test validator
   ...
   ```bash
   light test-validator --sbf-program "CDedNUM59y3vQpkghHWtgHvMWLZqbu1ZQ1Sn6Svs7rUA" ./target/deploy/anchor_program_close.so
   ```
