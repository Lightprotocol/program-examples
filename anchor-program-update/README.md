# Update Compressed Account Program (Anchor)

A program built with the Anchor framework to update a zk-compressed account's message field.
...
2. Start the test validator
   ...
   ```bash
   light test-validator --sbf-program "EW6Dr1FARqExStcxN3U5MzHn6ZYRYUVLdMByFtM9gYPh" ./target/deploy/anchor_program_update.so
   ```
